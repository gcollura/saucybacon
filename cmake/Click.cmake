if(CLICK_MODE)
    ...
    set(CMAKE_INSTALL_BINDIR /)
        set(DATA_DIR /)
        set(EXEC "qmlscene $@ -I .${QT_IMPORTS_DIR} ${NOTIKA_DIR}/${MAIN_QML}")
        set(DESKTOP_DIR ${DATA_DIR})
        set(ICON ".${DATA_DIR}/${ICON}")
    install(FILES manifest.json DESTINATION ${CMAKE_INSTALL_PREFIX})
    install(DIRECTORY "resources/images" DESTINATION ${DATA_DIR})
    install(FILES "${CMAKE_PROJECT_NAME}.apparmor" DESTINATION ${DATA_DIR})
else(CLICK_MODE)
